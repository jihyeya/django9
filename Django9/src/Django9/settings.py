...
#LOGIN_URL : login_required를 통해 보여질 로그인페이지 주소
...
DEBUG = False
#클라이언트가 웹서버에 요청할 때 허용할 도메인이름
#아무것도 적지 않은 경우 '127.0.0.1'로만 요청 가능
ALLOWED_HOSTS = ['127.0.0.1','localhost','.pythonanywhere.com']

#배포절차
#웹서버의 디버그모드 해제, 도메인주소 변경
#웹서버를 github 에 업로드
#배포사이트에서 웹프로젝트 다운로드
#가상환경 설치
#데이터베이스 연결 & 모델클래스 적용
...
INSTALLED_APPS = [
    ...
    'blog',
    'disqus', #댓글사이트와 연동하기 위한 어플리케이션
    'django.contrib.sites'
]
DISQUS_WEBSITE_SHORTNAME = 'jihyetest'
SITE_ID= 1
